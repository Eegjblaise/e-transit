...
class CreationAnnonce6 extends StatefulWidget {
  dynamic annonce;
  CreationAnnonce6({super.key, required this.annonce});

  @override
  State<CreationAnnonce6> createState() => _CreationAnnonce6State();
}

class _CreationAnnonce6State extends State<CreationAnnonce6> {
                          ...
                          child: Container(
                              ...
                              child: ListView(children: [
                                Text("Informations sur le kilos",
                                    ...
                                    style: GoogleFonts.inknutAntiqua(
                                        ...
                                        textStyle: Theme.of(context)
                                            ...
                                            .bodyMedium)),
                                Text(
                                    "Quel prix voulez vous pour chaque kilos en Euro",
                                    textAlign: TextAlign.start,
                                    style: GoogleFonts.inknutAntiqua(
                                        fontSize: 13,
                                ...
                                ListTile(
                                  ...
                                  title: Text(
                                      "Plus les prix sont attractifs plus vous avez la clientèle donc nous vous recommandons un maximum de 10",
                                      textAlign: TextAlign.start,
                                      style: GoogleFonts.manrope(
                                          fontSize: 13,
