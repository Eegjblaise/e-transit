...
class InscriptionPasseport extends StatefulWidget {
  User? user;
  InscriptionPasseport({super.key, required this.user});

  @override
  State<InscriptionPasseport> createState() => _InscriptionPasseportState();
}

class _InscriptionPasseportState extends State<InscriptionPasseport> {
  String pass = "";
