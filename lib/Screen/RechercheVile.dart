...
class RechercheVile extends StatefulWidget {
  void Function(dynamic)? onTap;
  RechercheVile({super.key, this.onTap});

  @override
  State<RechercheVile> createState() => _RechercheVileState();
}

class _RechercheVileState extends State<RechercheVile> {
  List enterprises = [];
  ...
  void initState() {
    super.initState();
    AutreService().getVile().then((value) {
      print(value);
      setState(() {
        productinit = value;
      });
